...
public class automationTestingConstants {
    ...
    public static final String BTN_SHIPPING_XPATH = "xpath://a[@href='http://practice.automationtesting.in/my-account/edit-address/shipping']";
    public static final String INPUT_SHIPPING_FIRSTNAME_ID = "id:shipping_first_name";
    public static final String BTN_ACCOUNT_DETAILS_XPATH = "xpath://a[@href='http://practice.automationtesting.in/my-account/edit-account/']";
