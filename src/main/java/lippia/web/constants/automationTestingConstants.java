...
public class automationTestingConstants {
    ...
    public static final String LI_USERNAME_INVALID_XPATH = "xpath://li[text()=' An account is already registered with your email address. Please login.']";
    public static final String LI_PASSWORD_INVALID_XPATH = "xpath://li[text()=' An account is already registered with your email address. Please login.']";
