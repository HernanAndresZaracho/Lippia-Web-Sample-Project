...
public class RegisterSteps extends PageSteps {
    ...
    public void elUsuarioVerificaQueSeRegistroCorrectamenteEnLaWeb() {
        RegisterHomeService.verificarRegister();
    }
